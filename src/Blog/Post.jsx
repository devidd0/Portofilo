...
const Post = (post) => {
  return (
    <div>
      ...
      <div
        className="w-72 group  cursor-pointer flex-col relative bg-bgBase3 text-baseHeaderColor h-44 rounded overflow-hidden flex items-center justify-center transform transition-all hover:scale-105 m-4"
      >
